...
#
#
# ResNet model for 4-channel classification input (B2, B3, B4, B8).
...
try:
    ...
    _RESNET_KW = {"weights": ResNet50_Weights.IMAGENET1K_V1}
except ImportError:
    _RESNET_KW = {"pretrained": True}

device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')

model = resnet50(**_RESNET_KW)

# modify first and final layer
model.conv1 = torch.nn.Conv2d(4, 64, kernel_size=(3, 3),
