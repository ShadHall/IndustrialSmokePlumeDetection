...
class SpectralJitter(object):
    """Per-channel multiplicative brightness jitter to simulate atmospheric and seasonal variation."""
...
class GaussianNoise(object):
    """Additive Gaussian noise to simulate sensor readout variation."""
